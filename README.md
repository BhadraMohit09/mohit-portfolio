...
- **Konami Code Easter Egg:** Listening for classic trigger keys ("mohit", "jha", or the classic Konami sequence) to activate interactive falling confetti achievements.
